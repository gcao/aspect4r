...
describe Aspect4r::Model::Advice do
  it "before? returns true for before advice" do
    advice = Aspect4r::Model::Advice.new Aspect4r::Model::Advice::BEFORE, :advice_method
  ...
  it "before? returns false for before advice" do
    advice = Aspect4r::Model::Advice.new Aspect4r::Model::Advice::BEFORE, :advice_method, :skip_if_false => true
  ...
  it "invoke after advice" do
    advice = Aspect4r::Model::Advice.new Aspect4r::Model::Advice::AFTER, :advice_method
  ...
  it "invoke around advice" do
    advice = Aspect4r::Model::Advice.new Aspect4r::Model::Advice::AROUND, :advice_method
